...
#line hidden
        ...
        public ToHaveASafeDeserealizationForTheYamlFileFeature(ToHaveASafeDeserealizationForTheYamlFileFeature.FixtureData fixtureData, MeerkatUpdater_Core_Test_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
...
#line hidden
        ...
        [Xunit.SkippableTheoryAttribute(DisplayName="😟 Invalid string payload")]
        [Xunit.TraitAttribute("FeatureTitle", "To have a safe deserealization for the Yaml file")]
        [Xunit.TraitAttribute("Description", "😟 Invalid string payload")]
        [Xunit.InlineDataAttribute("string.empty", new string[0])]
        [Xunit.InlineDataAttribute("null", new string[0])]
        public virtual void InvalidStringPayload(string payload, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("😟 Invalid string payload", null, exampleTags);
#line 13
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
        ...
        [Xunit.SkippableTheoryAttribute(DisplayName="😟 Invalid json payload")]
        [Xunit.TraitAttribute("FeatureTitle", "To have a safe deserealization for the Yaml file")]
        [Xunit.TraitAttribute("Description", "😟 Invalid json payload")]
        [Xunit.InlineDataAttribute("invalidPayload", new string[0])]
        public virtual void InvalidJsonPayload(string payload, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("😟 Invalid json payload", null, exampleTags);
#line 22
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
